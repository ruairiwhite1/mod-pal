...
export declare class DiscordUNO {
    ...
    private settings;
    private winners;
    constructor(client: Client, storage?: Collection<string, GameData>, gameCards?: Collection<string, {
        red: ({
            name: string;
            color: string;
            value: number;
    ...
    }>, settings?: Collection<string, Settings>, winners?: Collection<string, Winners[]>);
    /**
     ...
     */
    updateSettings(message: Message): Promise<void>;
    /**
