 ...
 * @param destination The path to the file destination
 */
export declare function createFileCopyAtomic(source: string, destination: string): Promise<void>;
export declare const ensureFileCopyAtomic: typeof createFileCopyAtomic;
