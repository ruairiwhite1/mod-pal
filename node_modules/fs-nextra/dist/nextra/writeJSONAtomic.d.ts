 ...
 * @param options The options to pass JSON.stringify and writeFile
 */
export declare function writeJSONAtomic(file: string, object: any, options?: JsonOptions): Promise<void>;
export declare const writeJsonAtomic: typeof writeJSONAtomic;
