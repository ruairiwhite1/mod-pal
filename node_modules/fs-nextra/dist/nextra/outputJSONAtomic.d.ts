 ...
 * @param options The write options or the encoding string.
 */
export declare function outputJSONAtomic(file: string, data: any, options?: JsonOptions): Promise<void>;
export declare const outputJsonAtomic: typeof outputJSONAtomic;
