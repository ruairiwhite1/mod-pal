 ...
 * @param atomic Whether the operation should run atomically
 */
export declare function createFileCopy(source: string, destination: string, atomic?: boolean): Promise<void>;
export declare const ensureFileCopy: typeof createFileCopy;
