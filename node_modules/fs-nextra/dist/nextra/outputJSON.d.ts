 ...
 * @param atomic If the operation should be done atomically
 */
export declare function outputJSON(file: string, data: any, atomic?: boolean): Promise<void>;
export declare function outputJSON(file: string, data: any, options?: JsonOptions, atomic?: boolean): Promise<void>;
export declare const outputJson: typeof outputJSON;
