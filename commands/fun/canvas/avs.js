...
module.exports = {
        ...
        aliases: ["avs"],
        category: "Image",
        description: "Combines two avatars together",
        expectedArgs: "[first mention | first username | first ID | first nickname] <second mention | second username | second ID | second nickname> ",
