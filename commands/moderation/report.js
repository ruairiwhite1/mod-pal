...
module.exports = {
    ...
    callback: async ({ message, args, text, client, prefix, instance }) => {
        if (!args[0]) return message.channel.send('You need to mention someone for this report. Ex: ``au!report (@Member)``');
        ...
        if (!reportMessage) return message.channel.send('You need to provide a message for this report. Ex: ``au!report (@Member) (message)``');
